...
SEND_ORDERS_BROKER_MT5 = int(os.getenv("SEND_ORDERS_BROKER_MT5")) or 0
...
# info MT5
MT5_HOST = os.getenv("MT5_HOST") or "localhost"

PERCENTAGE_CLOSE_POSITIONS_MT4 = os.getenv("PERCENTAGE_CLOSE_POSITIONS_MT4") or None
PERCENTAGE_CLOSE_POSITIONS_MT5 = os.getenv("PERCENTAGE_CLOSE_POSITIONS_MT5") or None
